  ...
  try {
    ...
    const seedTest = {
      ...
      questions: [
        ...
        { type:'single', text:"In the Versa solution, how is Zero Trust access achieved?", options:["Device Posture, Geo-Location, User-Identity","VSPA, Protection Rules and URL Filtering","NGFW, Application Context","All Of Them"], correctIndex:0, points:1 },
        { type:'single', text:"What should be done if an app uses certificate pinning and TLS decryption is enabled?", options:["Create Do Not Decrypt TLS rule for the App","No Action required.","\"Bypass Certificate-Pinned Traffic\" Knob should be enabled","App traffic will be decrypted and Security Enforced"], correctIndex:2, points:1 },
        { type:'single', text:"A customer wants its mobile users to access only on-prem apps. Which Versa service should they subscribe to?", options:["ZPA","VSPA","VSIA","SASE"], correctIndex:1, points:1 },
        { type:'single', text:"Why should TLS decryption be enabled for private apps?", options:["Customer wants visibility of the Traffic.","To apply URL and APP-ID detection","For IPS and Malware Inspection","For DLP Inspection"], correctIndex:2, points:1 },
        { type:'single', text:"What type of Authentication is Supported in SASE?", options:["User based","Group Based","Device Based","All of them"], correctIndex:3, points:1 },
        { type:'single', text:"In the VSIA use case, when the user is in the office, how do we ensure private traffic is directly accessible?", options:["Trusted Network Detection","Trusted Network Hostname + Excluded Routes","Trusted Network Hostname + Trusted Routes","Trusted Network Hostname"], correctIndex:2, points:1 },
        { type:'single', text:"In Versa Analytics, a customer is not able to see SASE Web logs and Firewall logs. What is the problem?", options:["Logging in Secure Access Policies not enabled","Logging in Internet/Private Protection rules are not enabled","At the SSE Tenant level, SASE and Firewall logging is set to mode \"Archive\"","At the SSE Tenant level, SASE and Firewall logging is set to mode \"Analytics\""], correctIndex:3, points:1 },
        { type:'single', text:"Customers want the user to be prompted for the Password every 48 hrs.", options:["Configure the Cache timer.","Configure the Cookie timer.","This timer should be set on the customer IDP","Configure the logout interval."], correctIndex:1, points:1 },
        ...
        { type:'single', text:"What is the function of the DNS Profile in the Versa SASE Client configuration?", options:["To configure DNS Server and Split-Tunnelling on the User Machine.","To point routes and DNS towards S2S tunnel.","To configure DNS Server on SSE Gateways","All of them"], correctIndex:0, points:1 },
        ...
        { type:'single', text:"Which feature would you use to control granular application activity within SaaS applications?", options:["App-ID Firewall","URL Filtering","CASB","DLP"], correctIndex:2, points:1 },
        ...
        { type:'single', text:"In Versa DLP, how can you ensure a rule triggers only if a pattern occurs more than three times?", options:["Configure \"Minimum Occurrence\" threshold as 3","Configure Severity Threshold to Medium","Configure Severity Value to 3","Configure Severity Threshold to Low"], correctIndex:2, points:1 },
        { type:'single', text:"Which profile will you configure for assessing the regular device security posture?", options:["EIP Profile","Versa Secure Access Profile","EIP Object","EIP Agent Profile"], correctIndex:3, points:1 },
        { type:'single', text:"Which feature restricts users from uninstalling Versa SASE Client from their devices?", options:["Always-on","Admin Disable","Tamper Protection","Fail-Close"], correctIndex:2, points:1 },
        ...
        { type:'single', text:"What would you use to block users from sharing PII or financial data using OneDrive?", options:["CASB profile","DLP profile","File Filtering","Sandboxing"], correctIndex:1, points:1 },
        ...
        { type:'single', text:"Which feature lets VOS inspect and do DPI (deep-packet inspection) on SSL/TLS application traffic?", options:["SSL Inspection","SSL Decryption","SASE Web Monitoring","CASB"], correctIndex:1, points:1 },
        ...
        { type:'single', text:"Easy IPS in Versa covers vulnerabilities of which CVSS range?", options:["Up to 10 years","5 to year","Up to 5 years","6 to 10 years"], correctIndex:3, points:1 },
        { type:'single', text:"The customer wants to block all types of upload and only PDF while downloading, for all users.", options:["ATP + DLP","CASB + File Filtering","Custom IPS signature to block PDF and ATP for all uploads","URLF to block all PDF urls and CASB"], correctIndex:1, points:1 },
        { type:'single', text:"Versa SSE does not support IPv6 tunnels. If DNS resolves to an IPv6 address, the traffic will bypass SSE inspection. What is the recommended solution?", options:["Enable dual-stack tunneling (IPv4 and IPv6)","Block all AAAA (IPv6) DNS records using DNS filtering","Block IPv6 traffic on SSE Gateway","Disable DNS resolution entirely"], correctIndex:1, points:1 }
      ]
    };
